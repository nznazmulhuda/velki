...
function Sidebar({ setIsSidebar }) {
	return (
		<div className="bg-[#111111] w-[65%] z-[1000] relative overflow-y-scroll h-[100vh] top-0">
			<div>
				<div className="bg-black flex items-center justify-between sticky top-0 z-50">
