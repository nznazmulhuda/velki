        ...
        <div className="p-4">
            ...
            <div className="border-l-4 py-2 mt-4">
                ...
                <div className="text-center mt-4 text-xs md:text-sm space-y-2">
                    <p>
                        আপনি এখন থেকে সরাসরি ভেল্কি সাইটে এজেন্ট ছাড়াই একাউন্ট
                        খুলতে পারবেন।
                    </p>
                    <p>এই খানে সব কিছু অটোমেটিক - অপেক্ষার কোন বালাই নাই।</p>
                    <p>দিন রাত ২৪ ঘন্টা ডিপোজিট এবং উইথড্র করতে পারবেন।</p>
                    <p>
                        প্রতিবার ডিপোজিট এবং উইথড্র লিমিট হচ্ছে ৫০০ টাকা থেকে
                        ২৫০০০ টাকা পর্যন্ত।
                    </p>
                    <p>
            ...
            <div className="flex items-center justify-center flex-col mt-4 space-y-2">
                <h1 className="text-xl md:text-2xl text-center">
                    অটো ডিপোজিট আইডি খোলার জন্য এই হোয়াটসাপ নাম্বার এ মেসেজ দিতে
                    হবেঃ
                </h1>
