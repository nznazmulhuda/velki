function AccountCreate() {
    return (
        <div className="p-4">
            ...
            {/* first content */}
            <div className="border-l-4 px-4 my-8">
                ...
                <p className="text-gray-800 mb-3">
                    ভেল্কি তে একাউন্ট করতে হলে আপনার এজেন্ট এর মাধ্যমে একাউন্ট
                ...
                <a
                    ...
                    className="text-[#C00] hover:underline transition-all ease-in"
                >
            ...
            <p className="my-2 text-gray-800">
                ...
                দায়ভার ভেল্কি নিবে না এবং লিষ্ট এর এজেন্ট দের সব দায়ভার ভেল্কি
            ...
            <div className="space-y-1">
                <p className="text-gray-800 text-xs md:text-sm font-semibold">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-[#C00] hover:underline transition-all ease-in ml-1"
                    >
                        +15714028916
                    </a>{" "}
                    (আকাশ মালিক)
                ...
                <p className="text-gray-800 text-xs md:text-sm font-semibold">
                    ...
                    <a href="/" target="_blank" rel="noopener noreferrer" className="text-[#C00] hover:underline transition-all ease-in ml-1">
                        https://allagentlist.com/cs.php
                    </a>
                </p>

                <p className="text-gray-800 text-xs md:text-sm font-semibold">
                    একাউন্ট খোলার আগে নিচের লিঙ্কে ক্লিক করে শর্ত সমুহ জেনে নিন।
                    এই শর্ত সমুহ জানা অত্যন্ত জরুরীঃ নিয়মগুলো জানার জন্য এই
                    লিঙ্ক এ ক্লিক করুন।{" "}
                </p>
            </div>
        </div>
